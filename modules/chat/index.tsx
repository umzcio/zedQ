...
function ChatRoot(){
 ...
 return <><ModuleSurface slot="sidebar"><ChatSidebar chat={chat} closing={host.closing}/></ModuleSurface><ModuleSurface><ArtifactWorkspace chat={chat}>{chat.artifactsView?<ArtifactLibrary chat={chat}/>:<ChatView chat={chat} notes={host.workspace.notes} closing={host.closing} prepareNotes={host.flushWorkspace} settings={settings}/>}</ArtifactWorkspace></ModuleSurface><ModuleSurface slot="settings"><ConnectionsSettings chat={chat} closing={host.closing}/></ModuleSurface><ModuleSurface slot="skillsSettings"><SkillsSettings chat={chat} closing={host.closing}/></ModuleSurface></>
}
