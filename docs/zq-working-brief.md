...
- Existing memory project: Zach authorized inspecting `/projects/zBrain` on `remote-host`. The 2026-09-07 read-only inspection found a running implementation with a Markdown vault, FastAPI, SQLite/LanceDB, Ollama, source adapters, MCP tools, curation, and CLI brief hooks. See `zbrain-inspection-2026-09-07.md` for evidence and verification limits.
