      ...
      while ((end = buffer.indexOf('\n')) >= 0) {
        ...
        queue = queue.then(async () => {
          try {
            ...
            const allowed = ['INVALID_REQUEST','INVALID_SESSION_NAME','EXTERNAL_SESSION_REQUIRED','INVALID_MODEL','GIT_FETCH_FAILED','UNKNOWN_SESSION','LEASE_HELD','LEASE_REQUIRED','UNKNOWN_METHOD',
