...
import { IconContext, Check, House, NotePencil, Kanban, MagnifyingGlass, GearSix, ChatCircle, TerminalWindow, Sparkle, Sun, Moon, Desktop, Plus, SidebarSimple, Package, Microphone, Scroll, PlugsConnected } from '@phosphor-icons/react'
