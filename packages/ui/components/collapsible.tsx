...
export function CollapsibleTrigger({tooltip,title,...props}:React.ComponentProps<typeof CollapsiblePrimitive.Trigger>&{tooltip?:React.ReactNode}){return <ControlTooltip content={tooltip??title??(controlText(props.children)?undefined:props['aria-label'])}><CollapsiblePrimitive.Trigger {...props}/></ControlTooltip>}
