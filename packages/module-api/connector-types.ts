...
export type Connector = {id:string;name:string;url:string;status:'disconnected'|'connecting'|'authenticating'|'connected'|'error';error?:string;needsSignIn?:boolean;autoConnect?:boolean;revision:number;clientId?:string;clientMetadataUrl?:string;catalogId?:string;authType?:ConnectorAuthType;hasToken?:boolean;hasClientSecret?:boolean;redirectPort?:number;redirectHost?:'127.0.0.1'|'localhost';tools:ConnectorTool[]}
