...
export type View = 'HQ' | 'Notes' | 'Tasks' | 'Settings' | 'Chat'
export type ModuleManifest = {id:string;version:string;apiVersion:1;title:string;view:Exclude<View,'Settings'>;icon:'home'|'notes'|'tasks'|'chat';capabilities:string[]}
